...
var SpeechRecognitionService = (function () {
    function SpeechRecognitionService(zone, _http) {
        this.zone = zone;
        this._http = _http;
        ...
        this.urlContinueCheck = this.baseLocal + '/speechcheckcontinue';
    }
    ...
    SpeechRecognitionService.prototype.getContinueResult = function (response) {
